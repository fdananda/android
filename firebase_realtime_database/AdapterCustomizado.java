...
public class AdapterCustomizado extends ArrayAdapter<Atributo> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView atributo1 = (TextView) viewPersonalizada.findViewById(R.id.TextViewRecuperarAtributo1);
        TextView atributo2 = (TextView) viewPersonalizada.findViewById(R.id.TextViewRecuperarAtributo2);
        TextView atributo3 = (TextView) viewPersonalizada.findViewById(R.id.TextViewRecuperarAtributo3);
